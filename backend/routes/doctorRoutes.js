...
const { scheduleValidation, validateSchedule } = require('../validators/scheduleValidator');
const {
  getDoctors,
  getDoctor,
  createDoctor,
...
router.post('/', verifyToken, allowRoles(1), createDoctor);
...
router.post('/:id/schedule', verifyToken, allowRoles(1, 2), scheduleValidation, validateSchedule, createScheduleSlot);
